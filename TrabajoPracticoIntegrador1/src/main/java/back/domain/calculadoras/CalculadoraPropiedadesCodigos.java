...
public class CalculadoraPropiedadesCodigos {
	...
	public String invoke(ArrayList<Double> informaciones, ArrayList<Integer> longitudes) {
		...
		if (i<informaciones.size())
			cadena = "La longitud del codigo "+i + 1+" es mayor que su informacion y no cumple la propiedad de codigo compacto según la desigualdad de Kraft";
		else
			cadena = "Se cumple la propiedad de codigo compacto seg�n la desigualdad de Kraft";
		return cadena;
	}
}
