...
import back.domain.calculadoras.CalculadoraPropiedadesCodigos;
...
public class GetCodigosInstantaneos implements Actionable{
    ...
    private final CalculadoraPropiedadesCodigos calculadoraPropiedadesCodigos = new CalculadoraPropiedadesCodigos();
    ...
    public String execute() {
        ...
        String kraft = calculadoraPropiedadesCodigos.invoke(longitudesIndividuales);
        String compacto = calculadoraPropiedadesCodigos.invoke(infosIndividuales, longitudesIndividuales);

        return formatter.format(probabilidades, infosIndividuales,
                entropiasIndividuales, entropia,
                longitudesIndividuales, longitudMedia,
                kraft, compacto);
    }
}
